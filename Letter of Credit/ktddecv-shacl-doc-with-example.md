...
# Worked Example — Finnish gluelam exported to Japan

Below, each **Node Shape** is illustrated with example instance data. Values are produced to be plausible and to satisfy the SHACL constraints. The predicates shown are the exact **`sh:path`** IRIs (i.e., `ktddecv:` properties where applicable).

## Additional Amount Category — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/AdditionalAmountCategory>
- **Example subject:** <https://example.org/fi-jp/AdditionalAmountCategory>
...
- **Example subject:** <https://example.org/fi-jp/AllowanceCharge>

**Property values (from example):**
- allowanceChargeReasonCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/allowanceChargeReasonCode>`): *(no value present in example)*
- perUnitAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/perUnitAmount>`): *(no value present in example)*
- chargeIndicator (`<https://iri.suomi.fi/model/ktddecv/0.0.4/chargeIndicator>`): *(no value present in example)*
- calculationPercent (`<https://iri.suomi.fi/model/ktddecv/0.0.4/calculationPercent>`): *(no value present in example)*
- multiplierFactorPercent (`<https://iri.suomi.fi/model/ktddecv/0.0.4/multiplierFactorPercent>`): *(no value present in example)*
- chargedToParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/chargedToParty>`): *(no value present in example)*
- chargedByParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/chargedByParty>`): *(no value present in example)*
- hasAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAmount>`): *(no value present in example)*
- baseAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/baseAmount>`): *(no value present in example)*

## Availability Method — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/AvailabilityMethod>
- **Example subject:** <https://example.org/fi-jp/AvailabilityMethod>

_No property constraints attached to this node shape._

## Bank Instruction — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/BankInstruction>
- **Example subject:** <https://example.org/fi-jp/BankInstruction>
...
**Property values (from example):**
- documentType (`<https://iri.suomi.fi/model/ktddecv/0.0.4/documentType>`): "Glued laminated timber beams"
- hasMessage (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasMessage>`): "Glued laminated timber beams"
...
**Property values (from example):**
- countryCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/countryCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- countryName (`<https://iri.suomi.fi/model/ktddecv/0.0.4/countryName>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>

## Credit Availability — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/CreditAvailability>
- **Example subject:** <https://example.org/fi-jp/CreditAvailability>

**Property values (from example):**
- tenor (`<https://iri.suomi.fi/model/ktddecv/0.0.4/tenor>`): *(no value present in example)*
- obligorParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/obligorParty>`): *(no value present in example)*
- availableWithQualifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/availableWithQualifier>`): *(no value present in example)*
- draweeParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/draweeParty>`): *(no value present in example)*
- hasAvailabilityMethod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAvailabilityMethod>`): *(no value present in example)*
- availableWithParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/availableWithParty>`): *(no value present in example)*
- hasAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAmount>`): *(no value present in example)*
- availableAtPlace (`<https://iri.suomi.fi/model/ktddecv/0.0.4/availableAtPlace>`): *(no value present in example)*
- maturityDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/maturityDate>`): *(no value present in example)*
- payeeParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/payeeParty>`): *(no value present in example)*

## Delivery Milestone — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/DeliveryMilestone>
- **Example subject:** <https://example.org/fi-jp/DeliveryMilestone>

**Property values (from example):**
- hasShipmentPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasShipmentPeriod>`): *(no value present in example)*
...
**Property values (from example):**
- documentDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/documentDate>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- documentIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/documentIdentifier>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>

## Document Requirement — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/DocumentRequirement>
- **Example subject:** <https://example.org/fi-jp/DocumentRequirement>

**Property values (from example):**
- requiredDocumentType (`<https://iri.suomi.fi/model/ktddecv/0.0.4/requiredDocumentType>`): *(no value present in example)*
- issuerParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/issuerParty>`): *(no value present in example)*
- numberOfCopies (`<https://iri.suomi.fi/model/ktddecv/0.0.4/numberOfCopies>`): *(no value present in example)*
- numberOfOriginals (`<https://iri.suomi.fi/model/ktddecv/0.0.4/numberOfOriginals>`): *(no value present in example)*
...
**Property values (from example):**
- confirmationAddedDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/confirmationAddedDate>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasPaymentTerms (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasPaymentTerms>`): <https://example.org/fi-jp/PaymentTerms>
- hasAvailabilityMethod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAvailabilityMethod>`): <https://example.org/fi-jp/AvailabilityMethod>
- additionalAmountsCovered (`<https://iri.suomi.fi/model/ktddecv/0.0.4/additionalAmountsCovered>`): <https://example.org/fi-jp/AdditionalAmountCategory>
- requestedConfirmationParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/requestedConfirmationParty>`): <https://example.org/fi-jp/Party>
- hasShipment (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasShipment>`): <https://example.org/fi-jp/Shipment>
- advisingBankParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/advisingBankParty>`): <https://example.org/fi-jp/Party>
- reimbursingBankParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/reimbursingBankParty>`): <https://example.org/fi-jp/Party>
- coversAdditionalCharge (`<https://iri.suomi.fi/model/ktddecv/0.0.4/coversAdditionalCharge>`): <https://example.org/fi-jp/AllowanceCharge>
- applicantParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/applicantParty>`): <https://example.org/fi-jp/Party>
- presentationPeriodDays (`<https://iri.suomi.fi/model/ktddecv/0.0.4/presentationPeriodDays>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasCreditAvailability (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasCreditAvailability>`): <https://example.org/fi-jp/CreditAvailability>
- requiresDocument (`<https://iri.suomi.fi/model/ktddecv/0.0.4/requiresDocument>`): <https://example.org/fi-jp/DocumentRequirement>
- partialShipmentAllowed (`<https://iri.suomi.fi/model/ktddecv/0.0.4/partialShipmentAllowed>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasPresentationPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasPresentationPeriod>`): <https://example.org/fi-jp/PeriodOfTime>
- maximumCreditAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/maximumCreditAmount>`): <https://example.org/fi-jp/MonetaryAmount>
- referencesPreAdvice (`<https://iri.suomi.fi/model/ktddecv/0.0.4/referencesPreAdvice>`): <https://example.org/fi-jp/Document>
- includesAllowanceCharge (`<https://iri.suomi.fi/model/ktddecv/0.0.4/includesAllowanceCharge>`): <https://example.org/fi-jp/AllowanceCharge>
- expiryDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/expiryDate>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- latestShipmentDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/latestShipmentDate>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- issuingBankParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/issuingBankParty>`): <https://example.org/fi-jp/Party>
- hasDeliveryMilestone (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasDeliveryMilestone>`): <https://example.org/fi-jp/DeliveryMilestone>
- applicableRules (`<https://iri.suomi.fi/model/ktddecv/0.0.4/applicableRules>`): <https://example.org/fi-jp/RuleSet>
- issueDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/issueDate>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasShipmentPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasShipmentPeriod>`): <https://example.org/fi-jp/PeriodOfTime>
- presentationBaseEvent (`<https://iri.suomi.fi/model/ktddecv/0.0.4/presentationBaseEvent>`): <https://example.org/fi-jp/ShipmentBasis>
- beneficiaryParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/beneficiaryParty>`): <https://example.org/fi-jp/Party>
- hasPaymentLine (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasPaymentLine>`): <https://example.org/fi-jp/PaymentLine>
- additionalConditionsText (`<https://iri.suomi.fi/model/ktddecv/0.0.4/additionalConditionsText>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- confirmingParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/confirmingParty>`): <https://example.org/fi-jp/Party>
- confirmationInstructionCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/confirmationInstructionCode>`): <https://example.org/fi-jp/Concept>
- creditAmountTolerancePercentage (`<https://iri.suomi.fi/model/ktddecv/0.0.4/creditAmountTolerancePercentage>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- latestPresentationDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/latestPresentationDate>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- applicantBankParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/applicantBankParty>`): <https://example.org/fi-jp/Party>
- placeOfExpiry (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfExpiry>`): <https://example.org/fi-jp/Location>
- adviseThroughBankParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/adviseThroughBankParty>`): <https://example.org/fi-jp/Party>
- draweeParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/draweeParty>`): <https://example.org/fi-jp/Party>
- placeOfPresentation (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfPresentation>`): <https://example.org/fi-jp/Location>
- documentaryCreditTypeCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/documentaryCreditTypeCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- creditIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/creditIdentifier>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- instructionToBank (`<https://iri.suomi.fi/model/ktddecv/0.0.4/instructionToBank>`): <https://example.org/fi-jp/BankInstruction>
- transshipmentAllowed (`<https://iri.suomi.fi/model/ktddecv/0.0.4/transshipmentAllowed>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
...
- **Example subject:** <https://example.org/fi-jp/GoodsItem>

**Property values (from example):**
- descriptionOfGoodsText (`<https://iri.suomi.fi/model/ktddecv/0.0.4/descriptionOfGoodsText>`): *(no value present in example)*
- hasQuantity (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasQuantity>`): *(no value present in example)*
- hasDangerousGoodsDetails (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasDangerousGoodsDetails>`): *(no value present in example)*
- productIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/productIdentifier>`): *(no value present in example)*
- itemDescriptionText (`<https://iri.suomi.fi/model/ktddecv/0.0.4/itemDescriptionText>`): *(no value present in example)*
- appliedCommodityClassification (`<https://iri.suomi.fi/model/ktddecv/0.0.4/appliedCommodityClassification>`): *(no value present in example)*
- hasCountryOfOrigin (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasCountryOfOrigin>`): *(no value present in example)*
...
**Property values (from example):**
- instructionText (`<https://iri.suomi.fi/model/ktddecv/0.0.4/instructionText>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- instructingParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/instructingParty>`): "Glued laminated timber beams"
- instructedParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/instructedParty>`): "Glued laminated timber beams"

## Legal Entity — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/LegalEntity>
- **Example subject:** <https://example.org/fi-jp/LegalEntity>
...
**Property values (from example):**
- longitude (`<https://iri.suomi.fi/model/ktddecv/0.0.4/longitude>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- timeZone (`<https://iri.suomi.fi/model/ktddecv/0.0.4/timeZone>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- unlocode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/unlocode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- customsOfficeCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/customsOfficeCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- alternateName (`<https://iri.suomi.fi/model/ktddecv/0.0.4/alternateName>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- portFacilityCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/portFacilityCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasAddress (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAddress>`): <https://example.org/fi-jp/Address>
- locationCountry (`<https://iri.suomi.fi/model/ktddecv/0.0.4/locationCountry>`): <https://example.org/fi-jp/Country>
- borderCrossingPointCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/borderCrossingPointCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- iataCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/iataCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- geoWKT (`<https://iri.suomi.fi/model/ktddecv/0.0.4/geoWKT>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- uicStationCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/uicStationCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- elevationMeters (`<https://iri.suomi.fi/model/ktddecv/0.0.4/elevationMeters>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- description (`<https://iri.suomi.fi/model/ktddecv/0.0.4/description>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- locationID (`<https://iri.suomi.fi/model/ktddecv/0.0.4/locationID>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- icaoAirportCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/icaoAirportCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- postCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/postCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- locationName (`<https://iri.suomi.fi/model/ktddecv/0.0.4/locationName>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- terminalCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/terminalCode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- latitude (`<https://iri.suomi.fi/model/ktddecv/0.0.4/latitude>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasIdentifier>`): <https://example.org/fi-jp/Identifier>
- warehouseGLN (`<https://iri.suomi.fi/model/ktddecv/0.0.4/warehouseGLN>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>

## Monetary Amount — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/MonetaryAmount>
- **Example subject:** <https://example.org/fi-jp/MonetaryAmount>

**Property values (from example):**
- amountValue (`<https://iri.suomi.fi/model/ktddecv/0.0.4/amountValue>`): *(no value present in example)*
- currencyCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/currencyCode>`): *(no value present in example)*
...
**Property values (from example):**
- name (`<https://iri.suomi.fi/model/ktddecv/0.0.4/name>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- partyLegalEntity (`<https://iri.suomi.fi/model/ktddecv/0.0.4/partyLegalEntity>`): <https://example.org/fi-jp/LegalEntity>
- partyAddress (`<https://iri.suomi.fi/model/ktddecv/0.0.4/partyAddress>`): <https://example.org/fi-jp/Address>
- partyIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/partyIdentifier>`): <https://example.org/fi-jp/Identifier>

## Payment Line — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/PaymentLine>
- **Example subject:** <https://example.org/fi-jp/PaymentLine>

**Property values (from example):**
- hasAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAmount>`): *(no value present in example)*
- paymentSettlementMethod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/paymentSettlementMethod>`): *(no value present in example)*
- tenor (`<https://iri.suomi.fi/model/ktddecv/0.0.4/tenor>`): *(no value present in example)*
- payeeParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/payeeParty>`): *(no value present in example)*
- paymentDueDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/paymentDueDate>`): *(no value present in example)*

## Payment Schedule Line — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/PaymentScheduleLine>
- **Example subject:** <https://example.org/fi-jp/PaymentScheduleLine>

**Property values (from example):**
- baseAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/baseAmount>`): *(no value present in example)*
- paymentDueDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/paymentDueDate>`): *(no value present in example)*
- deferredPaymentDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/deferredPaymentDate>`): *(no value present in example)*
- hasAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasAmount>`): *(no value present in example)*
- amountPercentOfBase (`<https://iri.suomi.fi/model/ktddecv/0.0.4/amountPercentOfBase>`): *(no value present in example)*

## Payment Terms — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/PaymentTerms>
- **Example subject:** <https://example.org/fi-jp/PaymentTerms>

**Property values (from example):**
- paymentTermCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/paymentTermCode>`): *(no value present in example)*
- tenor (`<https://iri.suomi.fi/model/ktddecv/0.0.4/tenor>`): *(no value present in example)*
- hasPaymentScheduleLine (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasPaymentScheduleLine>`): *(no value present in example)*
- tenorPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/tenorPeriod>`): *(no value present in example)*

## Period of Time — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/PeriodOfTime>
- **Example subject:** <https://example.org/fi-jp/PeriodOfTime>

**Property values (from example):**
- startDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/startDate>`): *(no value present in example)*
- endDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/endDate>`): *(no value present in example)*
...
- **Example subject:** <https://example.org/fi-jp/RuleSet>

**Property values (from example):**
- publicationDate (`<https://iri.suomi.fi/model/ktddecv/0.0.4/publicationDate>`): *(no value present in example)*
- title (`<https://iri.suomi.fi/model/ktddecv/0.0.4/title>`): *(no value present in example)*
- ruleSetIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/ruleSetIdentifier>`): *(no value present in example)*
- versionIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/versionIdentifier>`): *(no value present in example)*
- publisher (`<https://iri.suomi.fi/model/ktddecv/0.0.4/publisher>`): *(no value present in example)*
...
**Property values (from example):**
- buyerParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/buyerParty>`): <https://example.org/fi-jp/Party>
- requestedDeliveryPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/requestedDeliveryPeriod>`): "Glued laminated timber beams"
- placeOfDeliveryUNLocode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfDeliveryUNLocode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- isRealizedByConsignment (`<https://iri.suomi.fi/model/ktddecv/0.0.4/isRealizedByConsignment>`): "Glued laminated timber beams"
...
- insuranceValueAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/insuranceValueAmount>`): <https://example.org/fi-jp/MonetaryAmount>
- finalDestinationUNLocode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/finalDestinationUNLocode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- portOfDischargeUNLocode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/portOfDischargeUNLocode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- relatedOrder (`<https://iri.suomi.fi/model/ktddecv/0.0.4/relatedOrder>`): "Glued laminated timber beams"
- invoiceDocument (`<https://iri.suomi.fi/model/ktddecv/0.0.4/invoiceDocument>`): <https://example.org/fi-jp/Document>
- hasGoodsItem (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasGoodsItem>`): <https://example.org/fi-jp/GoodsItem>
- declaredCustomsValueAmount (`<https://iri.suomi.fi/model/ktddecv/0.0.4/declaredCustomsValueAmount>`): <https://example.org/fi-jp/MonetaryAmount>
...
- shipmentIdentifier (`<https://iri.suomi.fi/model/ktddecv/0.0.4/shipmentIdentifier>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
...
- portOfLoadingUNLocode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/portOfLoadingUNLocode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- placeOfReceiptUNLocode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfReceiptUNLocode>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- sellerParty (`<https://iri.suomi.fi/model/ktddecv/0.0.4/sellerParty>`): "Glued laminated timber beams"
- hazardousRiskIndicator (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hazardousRiskIndicator>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- contractNumber (`<https://iri.suomi.fi/model/ktddecv/0.0.4/contractNumber>`): "Glued laminated timber beams"^^<http://www.w3.org/2001/XMLSchema#string>
- hasShipmentPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasShipmentPeriod>`): <https://example.org/fi-jp/PeriodOfTime>
- deliveryTerms (`<https://iri.suomi.fi/model/ktddecv/0.0.4/deliveryTerms>`): <https://example.org/fi-jp/TradeDeliveryTerms>

## Shipment Basis — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/ShipmentBasis>
- **Example subject:** <https://example.org/fi-jp/ShipmentBasis>

_No property constraints attached to this node shape._

## Trade Delivery Terms — example instance
- **Target class:** <https://iri.suomi.fi/model/ktddecv/0.0.4/TradeDeliveryTerms>
- **Example subject:** <https://example.org/fi-jp/TradeDeliveryTerms>

**Property values (from example):**
- relatesToConsignment (`<https://iri.suomi.fi/model/ktddecv/0.0.4/relatesToConsignment>`): *(no value present in example)*
- placeOfDischarge (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfDischarge>`): *(no value present in example)*
- placeOfDelivery (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfDelivery>`): *(no value present in example)*
- deliveryTermsText (`<https://iri.suomi.fi/model/ktddecv/0.0.4/deliveryTermsText>`): *(no value present in example)*
- hasDeliveryPeriod (`<https://iri.suomi.fi/model/ktddecv/0.0.4/hasDeliveryPeriod>`): *(no value present in example)*
- applicableRules (`<https://iri.suomi.fi/model/ktddecv/0.0.4/applicableRules>`): *(no value present in example)*
- placeOfLoading (`<https://iri.suomi.fi/model/ktddecv/0.0.4/placeOfLoading>`): *(no value present in example)*
- incotermsCode (`<https://iri.suomi.fi/model/ktddecv/0.0.4/incotermsCode>`): *(no value present in example)*
- includesAllowanceCharge (`<https://iri.suomi.fi/model/ktddecv/0.0.4/includesAllowanceCharge>`): *(no value present in example)*
...
ex:Allowance_Charge a ns1:AllowanceCharge ;
    ...
    ns1:allowanceChargeReasonCode "Glued laminated timber beams"^^xsd:string ;
    ns1:baseAmount 12500000.0 ;
    ns1:calculationPercent "Glued laminated timber beams"^^xsd:string ;
    ns1:chargeIndicator "Glued laminated timber beams"^^xsd:string ;
    ns1:chargedByParty "Glued laminated timber beams" ;
    ns1:chargedToParty "Glued laminated timber beams" ;
    ns1:hasAmount 12500000.0 ;
    ns1:multiplierFactorPercent "Glued laminated timber beams"^^xsd:string ;
...
ex:Business_Document a ns1:BusinessDocument ;
    ...
    ns1:documentType "Glued laminated timber beams" ;
    ns1:hasMessage "Glued laminated timber beams" .

ex:Credit_Availability a ns1:CreditAvailability ;
    rdfs:label "Credit Availability"@en ;
    ns1:availableAtPlace "Tokyo (JP TYOKO)" ;
    ns1:availableWithParty "Glued laminated timber beams" ;
    ns1:availableWithQualifier "Glued laminated timber beams" ;
    ns1:draweeParty ex:Party ;
    ns1:hasAmount 12500000.0 ;
    ns1:hasAvailabilityMethod ex:AvailabilityMethod ;
    ns1:maturityDate "Glued laminated timber beams"^^xsd:string ;
    ns1:obligorParty "Glued laminated timber beams" ;
    ns1:payeeParty "Glued laminated timber beams" ;
    ns1:tenor "Glued laminated timber beams"^^xsd:string .
...
ex:Document_Requirement a ns1:DocumentRequirement ;
    ...
    ns1:issuerParty "Glued laminated timber beams" ;
    ns1:numberOfCopies "Glued laminated timber beams"^^xsd:string ;
    ns1:numberOfOriginals "Glued laminated timber beams"^^xsd:string ;
    ns1:requiredDocumentType "Glued laminated timber beams" .
...
ex:Documentary_Credit a ns1:DocumentaryCredit ;
    ...
    ns1:additionalConditionsText "Glued laminated timber beams"^^xsd:string ;
    ...
    ns1:confirmationAddedDate "Glued laminated timber beams"^^xsd:string ;
    ns1:confirmationInstructionCode ex:Concept ;
    ns1:confirmingParty ex:Party ;
    ns1:coversAdditionalCharge ex:AllowanceCharge ;
    ns1:creditAmountTolerancePercentage "Glued laminated timber beams"^^xsd:string ;
    ns1:creditIdentifier "Glued laminated timber beams"^^xsd:string ;
    ns1:documentaryCreditTypeCode "Glued laminated timber beams"^^xsd:string ;
    ns1:draweeParty ex:Party ;
    ns1:expiryDate "Glued laminated timber beams"^^xsd:string ;
    ns1:hasAvailabilityMethod ex:AvailabilityMethod ;
    ...
    ns1:issueDate "Glued laminated timber beams"^^xsd:string ;
    ns1:issuingBankParty ex:Party ;
    ns1:latestPresentationDate "Glued laminated timber beams"^^xsd:string ;
    ns1:latestShipmentDate "Glued laminated timber beams"^^xsd:string ;
    ns1:maximumCreditAmount ex:MonetaryAmount ;
    ns1:partialShipmentAllowed "Glued laminated timber beams"^^xsd:string ;
    ns1:placeOfExpiry ex:Location ;
    ns1:placeOfPresentation ex:Location ;
    ns1:presentationBaseEvent ex:ShipmentBasis ;
    ns1:presentationPeriodDays "Glued laminated timber beams"^^xsd:string ;
    ...
    ns1:transshipmentAllowed "Glued laminated timber beams"^^xsd:string .
...
ex:Goods_Item a ns1:GoodsItem ;
    ...
    ns1:appliedCommodityClassification "Glued laminated timber beams" ;
    ns1:descriptionOfGoodsText "Glued laminated timber beams"^^xsd:string ;
    ns1:hasCountryOfOrigin "Glued laminated timber beams" ;
    ns1:hasDangerousGoodsDetails "Glued laminated timber beams" ;
    ns1:hasQuantity 250 ;
    ns1:itemDescriptionText "Glued laminated timber beams"^^xsd:string ;
    ns1:productIdentifier "Glued laminated timber beams"^^xsd:string .

ex:Instruction a ns1:Instruction ;
    rdfs:label "Instruction"@en ;
    ns1:instructedParty "Glued laminated timber beams" ;
    ns1:instructingParty "Glued laminated timber beams" ;
    ns1:instructionText "Glued laminated timber beams"^^xsd:string .
...
ex:Monetary_Amount a ns1:MonetaryAmount ;
    ...
    ns1:amountValue "Glued laminated timber beams"^^xsd:string ;
    ns1:currencyCode "Glued laminated timber beams"^^xsd:string .

ex:Payment_Line a ns1:PaymentLine ;
    rdfs:label "Payment Line"@en ;
    ns1:hasAmount 12500000.0 ;
    ns1:payeeParty "Glued laminated timber beams" ;
    ns1:paymentDueDate "Glued laminated timber beams"^^xsd:string ;
    ns1:paymentSettlementMethod "Glued laminated timber beams" ;
    ns1:tenor "Glued laminated timber beams"^^xsd:string .

ex:Payment_Schedule_Line a ns1:PaymentScheduleLine ;
    rdfs:label "Payment Schedule Line"@en ;
    ns1:amountPercentOfBase "Glued laminated timber beams"^^xsd:string ;
    ns1:baseAmount 12500000.0 ;
    ns1:deferredPaymentDate "Glued laminated timber beams"^^xsd:string ;
    ns1:hasAmount 12500000.0 ;
    ns1:paymentDueDate "Glued laminated timber beams"^^xsd:string .
...
ex:Payment_Terms a ns1:PaymentTerms ;
    ...
    ns1:paymentTermCode "Glued laminated timber beams"^^xsd:string ;
    ns1:tenor "Glued laminated timber beams"^^xsd:string ;
    ns1:tenorPeriod "Glued laminated timber beams" .

ex:Period_of_Time a ns1:PeriodOfTime ;
    rdfs:label "Period of Time"@en ;
    ns1:endDate "Glued laminated timber beams"^^xsd:string ;
    ns1:startDate "Glued laminated timber beams"^^xsd:string .
...
ex:Rule_Set a ns1:RuleSet ;
    ...
    ns1:publicationDate "Glued laminated timber beams"^^xsd:string ;
    ns1:publisher "Glued laminated timber beams" ;
    ns1:ruleSetIdentifier "Glued laminated timber beams"^^xsd:string ;
    ns1:title "Glued laminated timber beams"^^xsd:string ;
    ns1:versionIdentifier "Glued laminated timber beams"^^xsd:string .
...
ex:Trade_Delivery_Terms a ns1:TradeDeliveryTerms ;
    ...
    ns1:applicableRules ex:RuleSet ;
    ns1:deliveryTermsText "Glued laminated timber beams"^^xsd:string ;
    ns1:hasDeliveryPeriod "Glued laminated timber beams" ;
    ns1:includesAllowanceCharge ex:AllowanceCharge ;
    ns1:incotermsCode "JP" ;
    ns1:placeOfDelivery "Tokyo (JP TYOKO)" ;
    ns1:placeOfDischarge "Tokyo (JP TYOKO)" ;
    ns1:placeOfLoading "Tokyo (JP TYOKO)" ;
    ns1:relatesToConsignment "Glued laminated timber beams" .
...
ex:Country a ns1:Country ;
    rdfs:label "Example Country",
        "Country"@en ;
    ns1:countryCode "Glued laminated timber beams"^^xsd:string ;
    ns1:countryName "Glued laminated timber beams"^^xsd:string .
...
ex:Shipment a ns1:Shipment ;
    ...
    ns1:contractNumber "Glued laminated timber beams"^^xsd:string ;
    ns1:declaredCustomsValueAmount ex:MonetaryAmount ;
    ns1:deliveryTerms ex:TradeDeliveryTerms ;
    ns1:finalDestinationUNLocode "Glued laminated timber beams"^^xsd:string ;
    ns1:hasGoodsItem ex:GoodsItem ;
    ns1:hasShipmentPeriod ex:PeriodOfTime ;
    ns1:hazardousRiskIndicator "Glued laminated timber beams"^^xsd:string ;
    ns1:insuranceValueAmount ex:MonetaryAmount ;
    ns1:invoiceDocument ex:Document ;
    ns1:isRealizedByConsignment "Glued laminated timber beams" ;
    ns1:placeOfDeliveryUNLocode "Glued laminated timber beams"^^xsd:string ;
    ns1:placeOfReceiptUNLocode "Glued laminated timber beams"^^xsd:string ;
    ns1:portOfDischargeUNLocode "Glued laminated timber beams"^^xsd:string ;
    ns1:portOfLoadingUNLocode "Glued laminated timber beams"^^xsd:string ;
    ns1:relatedOrder "Glued laminated timber beams" ;
    ns1:requestedDeliveryPeriod "Glued laminated timber beams" ;
    ns1:sellerParty "Glued laminated timber beams" ;
    ns1:shipmentIdentifier "Glued laminated timber beams"^^xsd:string ;
...
ex:Document a ns1:Document ;
    rdfs:label "Example Document",
        "Document"@en ;
    ns1:documentDate "Glued laminated timber beams"^^xsd:string ;
    ns1:documentIdentifier "Glued laminated timber beams"^^xsd:string .
...
ex:Location a ns1:Location ;
    rdfs:label "Example Location",
        "Location"@en ;
    ns1:alternateName "Glued laminated timber beams"^^xsd:string ;
    ns1:borderCrossingPointCode "Glued laminated timber beams"^^xsd:string ;
    ns1:customsOfficeCode "Glued laminated timber beams"^^xsd:string ;
    ns1:description "Glued laminated timber beams"^^xsd:string ;
    ns1:elevationMeters "Glued laminated timber beams"^^xsd:string ;
    ns1:geoWKT "Glued laminated timber beams"^^xsd:string ;
    ns1:hasAddress ex:Address ;
    ns1:hasIdentifier ex:Identifier ;
    ns1:iataCode "Glued laminated timber beams"^^xsd:string ;
    ns1:icaoAirportCode "Glued laminated timber beams"^^xsd:string ;
    ns1:latitude "Glued laminated timber beams"^^xsd:string ;
    ns1:locationCountry ex:Country ;
    ns1:locationID "Glued laminated timber beams"^^xsd:string ;
    ns1:locationName "Glued laminated timber beams"^^xsd:string ;
    ns1:longitude "Glued laminated timber beams"^^xsd:string ;
    ns1:portFacilityCode "Glued laminated timber beams"^^xsd:string ;
    ns1:postCode "Glued laminated timber beams"^^xsd:string ;
    ns1:terminalCode "Glued laminated timber beams"^^xsd:string ;
    ns1:timeZone "Glued laminated timber beams"^^xsd:string ;
    ns1:uicStationCode "Glued laminated timber beams"^^xsd:string ;
    ns1:unlocode "Glued laminated timber beams"^^xsd:string ;
    ns1:warehouseGLN "Glued laminated timber beams"^^xsd:string .
...
ex:Party a ns1:Party ;
    rdfs:label "Example Party",
        "Party"@en ;
    ns1:name "Glued laminated timber beams"^^xsd:string ;
