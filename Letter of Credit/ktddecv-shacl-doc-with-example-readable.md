...
ex:Allowance_Charge a ns1:AllowanceCharge ;
    ...
    ns1:chargedByParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:chargedToParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
...
ex:Credit_Availability a ns1:CreditAvailability ;
    ...
    ns1:availableWithParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:availableWithQualifier "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:draweeParty ex:Party ;
    ns1:hasAmount 12500000.0 ;
    ns1:hasAvailabilityMethod ex:AvailabilityMethod ;
    ns1:maturityDate "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:obligorParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:payeeParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:tenor "Suomi Wood Oy or Tokyo Build KK (depending on role)" .
...
ex:Document_Requirement a ns1:DocumentRequirement ;
    ...
    ns1:issuerParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
...
ex:Documentary_Credit a ns1:DocumentaryCredit ;
    ...
    ns1:confirmationAddedDate "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ...
    ns1:latestPresentationDate "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ...
    ns1:transshipmentAllowed "Suomi Wood Oy or Tokyo Build KK (depending on role)" .
...
ex:Goods_Item a ns1:GoodsItem ;
    ...
    ns1:appliedCommodityClassification "Batch of laminated timber beams, length 12 m, moisture‑controlled" ;
...
ex:Instruction a ns1:Instruction ;
    ...
    ns1:instructedParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:instructingParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:instructionText "Suomi Wood Oy or Tokyo Build KK (depending on role)" .
...
ex:Payment_Line a ns1:PaymentLine ;
    ...
    ns1:hasAmount 12500000.0 ;
    ns1:payeeParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
    ns1:paymentDueDate "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
...
ex:Trade_Delivery_Terms a ns1:TradeDeliveryTerms ;
    ...
    ns1:relatesToConsignment "Structural glulam beams for residential construction, quality GL28h" .
...
ex:Shipment a ns1:Shipment ;
    ...
    ns1:hasShipmentPeriod ex:PeriodOfTime ;
    ns1:hazardousRiskIndicator "Batch of laminated timber beams, length 12 m, moisture‑controlled" ;
    ns1:insuranceValueAmount ex:MonetaryAmount ;
    ns1:invoiceDocument ex:Document ;
    ns1:isRealizedByConsignment "Structural glulam beams for residential construction, quality GL28h" ;
    ...
    ns1:sellerParty "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
...
ex:Location a ns1:Location ;
    rdfs:label "Example Location",
        "Location"@en ;
    ns1:alternateName "Kotka, FI or Tokyo, JP" ;
    ...
    ns1:locationName "Kotka, FI or Tokyo, JP" ;
    ns1:longitude "Kotka, FI or Tokyo, JP" ;
...
ex:Party a ns1:Party ;
    rdfs:label "Example Party",
        "Party"@en ;
    ns1:name "Suomi Wood Oy or Tokyo Build KK (depending on role)" ;
