...
ex:Allowance_Charge a ns1:AllowanceCharge ;
    ...
    ns1:allowanceChargeReasonCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:baseAmount 12500000.0 ;
    ns1:calculationPercent "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:chargeIndicator "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:chargedByParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:chargedToParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:hasAmount 12500000.0 ;
    ns1:multiplierFactorPercent "Structural glulam beams, GL28h, planed, kiln-dried" ;
...
ex:Business_Document a ns1:BusinessDocument ;
    ...
    ns1:documentType "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:hasMessage "Structural glulam beams, GL28h, planed, kiln-dried" .

ex:Credit_Availability a ns1:CreditAvailability ;
    rdfs:label "Credit Availability"@en ;
    ns1:availableAtPlace "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:availableWithParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:availableWithQualifier "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:draweeParty ex:Party ;
    ns1:hasAmount 12500000.0 ;
    ns1:hasAvailabilityMethod ex:AvailabilityMethod ;
    ns1:maturityDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:obligorParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:payeeParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:tenor "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Document_Requirement a ns1:DocumentRequirement ;
    ...
    ns1:issuerParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:numberOfCopies "LC-2025-000123" ;
    ns1:numberOfOriginals "LC-2025-000123" ;
    ns1:requiredDocumentType "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Documentary_Credit a ns1:DocumentaryCredit ;
    ...
    ns1:additionalConditionsText "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ...
    ns1:confirmationAddedDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ...
    ns1:creditIdentifier "LC-2025-000123" ;
    ns1:documentaryCreditTypeCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:draweeParty ex:Party ;
    ...
    ns1:latestPresentationDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:latestShipmentDate "2025-02-20"^^xsd:date ;
    ns1:maximumCreditAmount ex:MonetaryAmount ;
    ns1:partialShipmentAllowed "MS Aurora Baltic" ;
    ns1:placeOfExpiry ex:Location ;
    ns1:placeOfPresentation ex:Location ;
    ns1:presentationBaseEvent ex:ShipmentBasis ;
    ns1:presentationPeriodDays "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ...
    ns1:transshipmentAllowed "MS Aurora Baltic" .
...
ex:Goods_Item a ns1:GoodsItem ;
    ...
    ns1:appliedCommodityClassification "4412.33" ;
    ns1:descriptionOfGoodsText "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:hasCountryOfOrigin "FI" ;
    ns1:hasDangerousGoodsDetails "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:hasQuantity 250 ;
    ns1:itemDescriptionText "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:productIdentifier "LC-2025-000123" .

ex:Instruction a ns1:Instruction ;
    rdfs:label "Instruction"@en ;
    ns1:instructedParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:instructingParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:instructionText "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Payment_Line a ns1:PaymentLine ;
    ...
    ns1:hasAmount 12500000.0 ;
    ns1:payeeParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:paymentDueDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:paymentSettlementMethod "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:tenor "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Payment_Schedule_Line a ns1:PaymentScheduleLine ;
    ...
    ns1:baseAmount 12500000.0 ;
    ns1:deferredPaymentDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:hasAmount 12500000.0 ;
    ns1:paymentDueDate "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Payment_Terms a ns1:PaymentTerms ;
    ...
    ns1:paymentTermCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:tenor "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:tenorPeriod "Structural glulam beams, GL28h, planed, kiln-dried" .

ex:Period_of_Time a ns1:PeriodOfTime ;
    rdfs:label "Period of Time"@en ;
    ns1:endDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:startDate "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Rule_Set a ns1:RuleSet ;
    ...
    ns1:publicationDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:publisher "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:ruleSetIdentifier "LC-2025-000123" ;
    ns1:title "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:versionIdentifier "LC-2025-000123" .
...
ex:Trade_Delivery_Terms a ns1:TradeDeliveryTerms ;
    ...
    ns1:applicableRules ex:RuleSet ;
    ns1:deliveryTermsText "CIF Tokyo (Incoterms 2020)" ;
    ns1:hasDeliveryPeriod "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:includesAllowanceCharge ex:AllowanceCharge ;
    ns1:incotermsCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:placeOfDelivery "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:placeOfDischarge "JP TYOKO (Tokyo)" ;
    ns1:placeOfLoading "FI KTK (Kotka)" ;
    ns1:relatesToConsignment "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Country a ns1:Country ;
    rdfs:label "Example Country",
        "Country"@en ;
    ns1:countryCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:countryName "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Shipment a ns1:Shipment ;
    ...
    ns1:contractNumber "LC-2025-000123" ;
    ns1:declaredCustomsValueAmount ex:MonetaryAmount ;
    ns1:deliveryTerms ex:TradeDeliveryTerms ;
    ns1:finalDestinationUNLocode "JP TYOKO (Tokyo)" ;
    ns1:hasGoodsItem ex:GoodsItem ;
    ns1:hasShipmentPeriod ex:PeriodOfTime ;
    ns1:hazardousRiskIndicator "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:insuranceValueAmount ex:MonetaryAmount ;
    ns1:invoiceDocument ex:Document ;
    ns1:isRealizedByConsignment "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:placeOfDeliveryUNLocode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:placeOfReceiptUNLocode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:portOfDischargeUNLocode "FI KTK (Kotka)" ;
    ns1:portOfLoadingUNLocode "FI KTK (Kotka)" ;
    ns1:relatedOrder "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:requestedDeliveryPeriod "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:sellerParty "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:shipmentIdentifier "LC-2025-000123" ;
...
ex:Document a ns1:Document ;
    rdfs:label "Example Document",
        "Document"@en ;
    ns1:documentDate "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:documentIdentifier "INV-2025-000987" .
...
ex:Location a ns1:Location ;
    rdfs:label "Example Location",
        "Location"@en ;
    ns1:alternateName "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:borderCrossingPointCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:customsOfficeCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:description "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:elevationMeters "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:geoWKT "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:hasAddress ex:Address ;
    ns1:hasIdentifier ex:Identifier ;
    ns1:iataCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:icaoAirportCode "FI KTK (Kotka)" ;
    ns1:latitude "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:locationCountry ex:Country ;
    ns1:locationID "LC-2025-000123" ;
    ns1:locationName "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:longitude "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:portFacilityCode "FI KTK (Kotka)" ;
    ns1:postCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:terminalCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:timeZone "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:uicStationCode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:unlocode "Structural glulam beams, GL28h, planed, kiln-dried" ;
    ns1:warehouseGLN "Structural glulam beams, GL28h, planed, kiln-dried" .
...
ex:Party a ns1:Party ;
    rdfs:label "Example Party",
        "Party"@en ;
    ns1:name "Structural glulam beams, GL28h, planed, kiln-dried" ;
