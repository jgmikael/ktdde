# DCSA Glossary ↔ KTDDE SKOS (prefLabel + altLabel) — Expert-Match Report

Methodology:
- Normalized matching (lowercase, remove spaces/punctuation).
- Fuzzy thresholds: **≥ 0.90 strong**, **0.84–0.90 possible**.
- Both **prefLabel** and **altLabel** considered.

### Example sanity check
The DCSA term **“flashpoint”** should map to KTDDE **“flash point”** via normalization or fuzzy match. The table below includes that mapping if present.
